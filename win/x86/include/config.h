...
#define FFMPEG_CONFIGURATION "--pkg-config=pkg-config --pkg-config-flags=--static --extra-version=ffmpeg-windows-build-helpers --enable-version3 --disable-debug --disable-w32threads --arch=x86 --target-os=mingw32 --cross-prefix=/home/satoharu/UnityProjects/FfmpegUnity/Projects/ffmpeg-windows-build-helpers_2/ffmpeg-windows-build-helpers/sandbox/cross_compilers/mingw-w64-i686/bin/i686-w64-mingw32- --enable-libopus --enable-libtheora --enable-libvorbis --enable-libwebp --enable-libopenh264 --enable-gmp --enable-gnutls --enable-libmp3lame --enable-libxml2 --enable-libaom --enable-libvpx --enable-nvenc --enable-nvdec --extra-libs=-lharfbuzz --extra-libs=-lm --extra-libs=-lshlwapi --extra-libs=-lmpg123 --extra-libs=-lpthread --extra-cflags=-DLIBTWOLAME_STATIC --extra-cflags=-DMODPLUG_STATIC --extra-cflags=-DCACA_STATIC --enable-amf --enable-libmfx --extra-cflags='-mtune=generic' --extra-cflags=-O3 --enable-shared --disable-static --prefix=/home/satoharu/UnityProjects/FfmpegUnity/Projects/ffmpeg-windows-build-helpers_2/ffmpeg-windows-build-helpers/sandbox/win32/ffmpeg_git_lgpl_n5.1.1_shared"
#define FFMPEG_LICENSE "LGPL version 3 or later"
#define CONFIG_THIS_YEAR 2022
#define FFMPEG_DATADIR "/home/satoharu/UnityProjects/FfmpegUnity/Projects/ffmpeg-windows-build-helpers_2/ffmpeg-windows-build-helpers/sandbox/win32/ffmpeg_git_lgpl_n5.1.1_shared/share/ffmpeg"
#define AVCONV_DATADIR "/home/satoharu/UnityProjects/FfmpegUnity/Projects/ffmpeg-windows-build-helpers_2/ffmpeg-windows-build-helpers/sandbox/win32/ffmpeg_git_lgpl_n5.1.1_shared/share/ffmpeg"
