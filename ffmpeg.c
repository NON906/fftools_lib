...
static THREAD_LOCAL int64_t nb_frames_dup = 0;
static THREAD_LOCAL uint64_t dup_warning = 1000;
static THREAD_LOCAL int64_t nb_frames_drop = 0;
static THREAD_LOCAL int64_t decode_error_stat[2];
THREAD_LOCAL unsigned nb_output_dumped = 0;

THREAD_LOCAL int want_sdp = 1;
...
THREAD_LOCAL int main_return_code = 0;
